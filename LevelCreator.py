...
def world_2_2_water(screen, settings, start_pos=None):
    ...
    new_level.place_item("Coin", 70, 3)
    new_level.place_item("Coin", 102, 2)
    new_level.place_item("Coin", 103, 2)
    new_level.place_item("Coin", 104, 2)
    new_level.place_item("Coin", 114, 7)
    new_level.place_item("Coin", 115, 7)
    new_level.place_item("Coin", 116, 7)
    new_level.place_item("Coin", 134, 2)
    new_level.place_item("Coin", 135, 1)
    new_level.place_item("Coin", 136, 1)
    new_level.place_item("Coin", 137, 1)
    new_level.place_item("Coin", 138, 2)
    new_level.place_item("Coin", 160, 1)
    new_level.place_item("Coin", 161, 1)
    new_level.place_item("Coin", 162, 1)
    new_level.place_item("Coin", 160, 4)
    new_level.place_item("Coin", 161, 4)
    new_level.place_item("Coin", 162, 4)

    new_level.place_enemy("blooper", 22, 1)
    new_level.place_enemy("blooper", 46, 3)
    new_level.place_enemy("blooper", 55, 2)
    new_level.place_enemy("cheep_cheep", 77, 3)
    new_level.place_enemy("cheep_cheep", 78, 5)
    new_level.place_enemy("cheep_cheep", 82, 2)
    new_level.place_enemy("blooper", 84, 4)
    new_level.place_enemy("cheep_cheep", 95, 6)
    new_level.place_enemy("blooper", 95, 8)
    new_level.place_enemy("cheep_cheep", 98, 9)
    new_level.place_enemy("cheep_cheep", 102, 3)
    new_level.place_enemy("blooper", 106, 1)
    new_level.place_enemy("cheep_cheep", 118, 9)
    new_level.place_enemy("cheep_cheep", 129, 3)
    new_level.place_enemy("cheep_cheep", 132, 2)
    new_level.place_enemy("cheep_cheep", 138, 5)
    new_level.place_enemy("cheep_cheep", 146, 3)
    new_level.place_enemy("cheep_cheep", 151, 7)
    new_level.place_enemy("cheep_cheep", 166, 9)
    new_level.place_enemy("cheep_cheep", 169, 1)
    new_level.place_enemy("cheep_cheep", 175, 5)
    new_level.place_enemy("cheep_cheep", 183, 9)
    new_level.place_enemy("cheep_cheep", 186, 5)
...
def world_2_3(screen, settings, start_pos=None):
    if start_pos is None:
        start_pos = [4.5, 1]
    new_level = \
        Level(screen, settings, 'Resources/Images/Backgrounds/World_2/2-3/2-3_background.png', 'Resources/Images/Backgrounds/World_2/2-3/2-3_floor.png', start_pos, [225, 2], 500, "2-3", settings.W_2_3, settings.W_2_4, settings.W_2_3)
    new_level.place_enemy("cheep_cheep", 18, 15)
    new_level.place_enemy("cheep_cheep", 20, 10)
    new_level.place_enemy("cheep_cheep", 22, 12)
    new_level.place_enemy("cheep_cheep", 25, 20)
    new_level.place_enemy("cheep_cheep", 26, 25)
    new_level.place_enemy("cheep_cheep", 28, 10)
    new_level.place_enemy("cheep_cheep", 31, 15)
    new_level.place_enemy("cheep_cheep", 35, 20)
    new_level.place_enemy("cheep_cheep", 37, 12)
    new_level.place_enemy("cheep_cheep", 41, 15)
    new_level.place_enemy("cheep_cheep", 43, 25)
    new_level.place_enemy("cheep_cheep", 45, 10)
    new_level.place_enemy("cheep_cheep", 55, 15)
    new_level.place_enemy("cheep_cheep", 56, 12)
    new_level.place_enemy("cheep_cheep", 57, 15)
    new_level.place_enemy("cheep_cheep", 59, 10)
    new_level.place_enemy("cheep_cheep", 62, 12)
    new_level.place_enemy("cheep_cheep", 64, 15)
    new_level.place_enemy("cheep_cheep", 65, 12)
    new_level.place_enemy("cheep_cheep", 72, 10)
    new_level.place_enemy("cheep_cheep", 75, 15)
    new_level.place_enemy("cheep_cheep", 82, 12)
    new_level.place_enemy("cheep_cheep", 84, 10)
    new_level.place_enemy("cheep_cheep", 86, 10)
    new_level.place_enemy("cheep_cheep", 92, 12)
    new_level.place_enemy("cheep_cheep", 93, 15)
    new_level.place_enemy("cheep_cheep", 97, 15)
    new_level.place_enemy("cheep_cheep", 100, 10)
    new_level.place_enemy("cheep_cheep", 105, 12)
    new_level.place_enemy("cheep_cheep", 107, 10)
    new_level.place_enemy("cheep_cheep", 115, 12)
    new_level.place_enemy("cheep_cheep", 118, 10)
    new_level.place_enemy("cheep_cheep", 120, 15)
    new_level.place_enemy("cheep_cheep", 127, 10)
    new_level.place_enemy("cheep_cheep", 130, 12)
    new_level.place_enemy("cheep_cheep", 132, 15)
    new_level.place_enemy("cheep_cheep", 138, 12)
    new_level.place_enemy("cheep_cheep", 145, 10)
    new_level.place_enemy("cheep_cheep", 155, 15)
    new_level.place_enemy("cheep_cheep", 156, 12)
    new_level.place_enemy("cheep_cheep", 157, 15)
    new_level.place_enemy("cheep_cheep", 159, 10)
    new_level.place_enemy("cheep_cheep", 162, 12)
    new_level.place_enemy("cheep_cheep", 164, 15)
    new_level.place_enemy("cheep_cheep", 165, 12)
    new_level.place_enemy("cheep_cheep", 172, 10)
    new_level.place_enemy("cheep_cheep", 175, 15)
    new_level.place_enemy("cheep_cheep", 182, 12)
    new_level.place_enemy("cheep_cheep", 184, 10)
    new_level.place_enemy("cheep_cheep", 186, 10)
    new_level.place_enemy("cheep_cheep", 192, 12)
    new_level.place_enemy("cheep_cheep", 193, 15)
