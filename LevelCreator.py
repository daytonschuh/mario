...
def world_2_3(screen, settings, start_pos=None):
    ...
    new_level.place_enemy("cheep_cheep", 30.5, 8)
    new_level.place_enemy("cheep_cheep", 42.7, 11)
    new_level.place_enemy("cheep_cheep", 50.5, 0)
    new_level.place_enemy("cheep_cheep", 60.7, 9.5)
    new_level.place_enemy("cheep_cheep", 62.8, 2.8)
    new_level.place_enemy("cheep_cheep", 69.9, 5.3)
    new_level.place_enemy("cheep_cheep", 74.5, 6.5)
    new_level.place_enemy("cheep_cheep", 83.7, 0.3)
    new_level.place_enemy("cheep_cheep", 88.7, 10.4)
    new_level.place_enemy("cheep_cheep", 89.8, 0.7)
    new_level.place_enemy("cheep_cheep", 114.7, 4)
    new_level.place_enemy("cheep_cheep", 122.6, 9.7)
    new_level.place_enemy("cheep_cheep", 144.8, 6)
    new_level.place_enemy("cheep_cheep", 154.8, 10.5)
    new_level.place_enemy("cheep_cheep", 160.4, 10.5)
    new_level.place_enemy("cheep_cheep", 171, 0.5)
    new_level.place_enemy("cheep_cheep", 182.5, 9.5)

    new_level.place_item("Coin", 36, 8)
    new_level.place_item("Coin", 37, 8)
    new_level.place_item("Coin", 38, 8)
    new_level.place_item("Coin", 39, 8)
    new_level.place_item("Coin", 55, 8)
    new_level.place_item("Coin", 56, 7)
    new_level.place_item("Coin", 57, 8)
    new_level.place_item("Coin", 58, 7)
    new_level.place_item("Coin", 59, 8)
    new_level.place_item("Coin", 71, 8)
    new_level.place_item("Coin", 72, 9)
    new_level.place_item("Coin", 73, 9)
    new_level.place_item("Coin", 74, 8)
    new_level.place_item("Coin", 97, 8)
    new_level.place_item("Coin", 98, 8)
    new_level.place_item("Coin", 99, 8)
    new_level.place_block("q", 102, 8, "Power-Up")
    new_level.place_item("Coin", 108, 8)
    new_level.place_item("Coin", 109, 8)
    new_level.place_item("Coin", 110, 8)
    new_level.place_item("Coin", 133, 8)
    new_level.place_item("Coin", 134, 8)
    new_level.place_item("Coin", 135, 8)
    new_level.place_item("Coin", 136, 8)
    new_level.place_item("Coin", 137, 8)
    new_level.place_item("Coin", 138, 8)
    new_level.place_item("Coin", 149, 5)
    new_level.place_item("Coin", 150, 5)
    new_level.place_item("Coin", 151, 5)
    new_level.place_item("Coin", 152, 5)
    new_level.place_item("Coin", 173, 7)
    new_level.place_item("Coin", 174, 7)
    new_level.place_item("Coin", 175, 7)
    new_level.place_item("Coin", 176, 7)
    new_level.place_item("Coin", 177, 7)
    new_level.place_item("Coin", 178, 7)
